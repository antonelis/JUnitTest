...
public class Yatzy {
    ...
    public static int ones(DiceHand diceHand) {
        return diceHand.stream().filter(d -> d == 1).sum();
    }

    public static int twos(DiceHand diceHand) {
        return diceHand.stream().filter(d -> d == 2).sum();
    }

    public static int threes(DiceHand diceHand) {
        return diceHand.stream().filter(d -> d == 3).sum();
    }

    public static int fours(DiceHand diceHand) {
        return diceHand.stream().filter(d -> d == 4).sum();
    }

    public static int fives(DiceHand diceHand) {
        return diceHand.stream().filter(d -> d == 5).sum();
    }

    public static int sixes(DiceHand diceHand) {
        return diceHand.stream().filter(d -> d == 6).sum();
    }
